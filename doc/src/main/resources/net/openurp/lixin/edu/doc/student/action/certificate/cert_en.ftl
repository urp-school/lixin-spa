...
. ${getAppOne(std.person.gender)} student ID is ${std.user.code} and ${getApp(std.person.gender)} is current[#t/]
  ...
  ${getAppBig(std.person.gender)} is supposed to graduate on ${(std.state.enOn?string('dd MMMMM,yyyy'))!(std.graduateOn?string('dd MMMMM,yyyy'))} under normal circumstance.[#t/]
</p>